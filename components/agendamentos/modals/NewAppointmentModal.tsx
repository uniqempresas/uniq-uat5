...
import { AppointmentFormData, NewAppointmentModalProps, Client } from '@/types/agendamentos';
import { mockServices, mockProfessionals, recentClients } from '@/lib/mocks/agendamentos';
...
export function NewAppointmentModal({
  ...
  useEffect(() => {
    if (step === 3 && formData.date && formData.professionalId) {
      loadAvailableSlots();
    }
  }, [step, formData.date, formData.professionalId]);
          ...
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-3 flex justify-center">
                  <Calendar
                    ...
                    className="w-full"
                    classNames={{
                      day_selected: "bg-[#3e5653] text-white hover:bg-[#2d413f]",
                      day_today: "bg-[#86cb92]/20 text-[#3e5653] font-bold",
                    }}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-3 h-[320px] overflow-y-auto">
                  {loadingSlots ? (
