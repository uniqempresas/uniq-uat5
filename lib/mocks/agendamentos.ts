import { Appointment, Professional, Service, WaitlistItem, ScheduleConfig, Holiday } from '@/types/agendamentos';
...
export const recentClients = [
  ...
  { id: 'cli-005', name: 'Carla Mendes', phone: '(11) 95555-5555', email: 'carla@email.com' },
  { id: 'cli-006', name: 'Lucas Oliveira', phone: '(11) 94444-4444', email: 'lucas@email.com' },
];
